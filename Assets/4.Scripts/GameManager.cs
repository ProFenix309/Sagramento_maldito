...
public class GameManager : MonoBehaviour, IDataPersistence
{
    ...
    private void OnSceneLoadedHandler(Scene scene, LoadSceneMode mode)
    {
        ...
        // Solo spawnear en escenas de juego (no en men�)
    ...
    {
        // Esperar un frame para que la escena est� completamente cargada
        yield return null;
    ...
    public void SpawnPlayer()
    {
        ...
        // Usar la posici�n guardada si existe y estamos en el acto correcto
    ...
    public void SaveData(GameData data)
    {
        ...
        // Actualizar posici�n del jugador si existe
        if (player != null)
        {
